...
class WebformWizardValidateTest extends WebformWizardTestBase {
  ...
  public function testWizardValidate() {
    ...
    $this->drupalPostForm('/webform/test_form_wizard_validate', [], 'Next Page >');
    ...
    $this->drupalPostForm('/webform/test_form_wizard_validate', $edit, 'Next Page >');
...
wizard_2_datelist:
  - '2002-02-02T02:20:00+1100'");
    ...
    // Check validation errors.
    $this->drupalPostForm('/webform/test_form_wizard_validate_comp', [], 'Next Page >');
    ...
    $this->drupalPostForm('/webform/test_form_wizard_validate_comp', $edit, 'Next Page >');
